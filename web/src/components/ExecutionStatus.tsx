        ...
        <div className="ms-auto ms-3">
          ...
          >
            <svg
              ...
              height="16"
              fill="currentColor"
              className="bi bi-upload d-none btn-activate-icon"
              viewBox="0 0 16 16"
            >
              <path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5" />
              <path d="M7.646 1.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1-.708.708L8.5 2.707V11.5a.5.5 0 0 1-1 0V2.707L5.354 4.854a.5.5 0 1 1-.708-.708z" />
            </svg>
            <span className="btn-activate-text">Aktivieren</span>
          </Button>
          <Button
          ...
          >
            <svg
              ...
              height="16"
              fill="currentColor"
              className="bi bi-play-fill d-none btn-play-icon"
              viewBox="0 0 16 16"
            >
              <path d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393" />
            </svg>
            <span className="btn-play-text">Starten</span>
          </Button>
          <Button
          ...
          >
            <svg
              ...
              height="16"
              fill="currentColor"
              className="bi bi-pause-fill d-none btn-pause-icon"
              viewBox="0 0 16 16"
            >
              <path d="M5.5 3.5A1.5 1.5 0 0 1 7 5v6a1.5 1.5 0 0 1-3 0V5a1.5 1.5 0 0 1 1.5-1.5m5 0A1.5 1.5 0 0 1 12 5v6a1.5 1.5 0 0 1-3 0V5a1.5 1.5 0 0 1 1.5-1.5" />
            </svg>
            <span className="btn-pause-text">Pause</span>
          </Button>
          <Button
          ...
          >
            <svg
              ...
              height="16"
              fill="currentColor"
              className="bi bi-stop-fill d-none btn-stop-icon"
              viewBox="0 0 16 16"
            >
              <path d="M5 3.5h6A1.5 1.5 0 0 1 12.5 5v6a1.5 1.5 0 0 1-1.5 1.5H5A1.5 1.5 0 0 1 3.5 11V5A1.5 1.5 0 0 1 5 3.5" />
            </svg>
            <span className="btn-stop-text">Stoppen</span>
          </Button>
        </div>
      </div>
    </div>
